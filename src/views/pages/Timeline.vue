    ...
    <div class="card">
        ...
        <Timeline :value="customEvents" align="alternate" class="customized-timeline">
            <template #marker="slotProps">
                <span class="flex z-10 w-8 h-8 items-center justify-center text-white rounded-full shadow" :style="{ backgroundColor: slotProps.item.color }">
            ...
            <template #content="slotProps">
                <Card>
                    ...
                    <template #content>
                        <img v-if="slotProps.item.image" :src="'/demo/images/product/' + slotProps.item.image" :alt="slotProps.item.name" width="200" class="shadow" />
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore sed consequuntur error repudiandae numquam deserunt quisquam repellat libero asperiores earum nam nobis, culpa ratione quam perferendis esse, cupiditate
                            neque quas!
                        </p>
                        <Button label="Read more" class="mb-8" outlined></Button>
                    </template>
                </Card>
            </template>
        </Timeline>
