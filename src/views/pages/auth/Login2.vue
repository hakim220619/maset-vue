...
<template>
    <div class="text-primary bg-primary-contrast bg-primary-50">
            ...
            <div class="w-full lg:w-5/12 h-screen text-center flex justify-center items-start">
                <div class="z-50 w-full lg:w-8/12 px-12 text-center mt-20" style="max-width: 400px">
                    ...
                    <div class="mt-8 text-left">
                        ...
                        <label for="username" class="block mb-2 mt-4" style="color: #4c566a">Password</label>
                        <IconField class="block">
                        ...
                        <div class="flex items-center justify-between mt-6 gap-4">
                            <Button label="Login" @click="navigateToDashboard" class="w-40"></Button>
